...
//First subprogram
static bool CheckStringLengthAndContetnt(std::string& __string)
{
...
static void StringProcessing(std::string& __string)
{
...
//Second subprogram
static int GetSumOfEvenNumbersInString(std::string& __string)
{
